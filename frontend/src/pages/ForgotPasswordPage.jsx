...
import Input from '../components/Input'; // Replace with a regular input if needed
    ...
    <div className="flex items-center justify-center min-h-screen bg-900">
      ...
      >
        ...
        <div className="mt-6 text-center">
          <Link to="/login" className="text-sm text-green-400 hover:underline flex items-center justify-center">
